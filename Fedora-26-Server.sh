...
# Negativo17 multimedia: (Needed for rar and unrar.)  NOTE: I do not use rar anymore. That's why it's commented out.
...
# Singular packages.
dnf install -y git wget curl htop nmap ruby gem gcc gcc-c++ python perl java-1.8.0-openjdk java-1.8.0-openjdk-devel vim transmission-cli iftop p7zip zip unzip
