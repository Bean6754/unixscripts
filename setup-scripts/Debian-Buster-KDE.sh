...
apt install -y wireshark-qt qbittorrent qupzilla krita kdenlive simplescreenrecorder vlc libdvdnav4 libdvdread4 libdvdcss2 libbluray2 redshift plasma-applet-redshift-control quassel qtcreator firefox-esr firefox-esr-l10n-en-gb
