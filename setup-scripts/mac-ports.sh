...
# Install software.
sudo $port -v install arping arp-scan autoconf automake clamav coreutils dsniff ettercap findutils iftop inetutils htop lua neofetch nmap python27 python36 py27-pip py36-pip rsync screen tcsh texlive tmux vim
