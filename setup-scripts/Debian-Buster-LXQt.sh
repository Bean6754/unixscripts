...
apt install -y wireshark-qt transmission-qt transmission-cli krita kdenlive simplescreenrecorder mpv libdvdnav4 libdvdread4 libdvdcss2 libbluray2 redshift quassel qtcreator firefox-esr firefox-esr-l10n-en-gb
