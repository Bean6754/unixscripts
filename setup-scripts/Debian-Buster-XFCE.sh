...
# High-level
apt install -y wireshark-gtk transmission-gtk pavucontrol xarchiver geany geany-plugins filezilla gparted gimp redshift pidgin firefox-esr firefox-esr-l10n-en-gb gpick software-properties-gtk synaptic gdebi conky-all
# Codecs
