...
dnf install -y adapta-gtk-theme adwaita-cursor-theme adwaita-icon-theme arc-theme numix-gtk-theme numix-icon-theme numix-icon-theme-circle paper-icon-theme tango-icon-theme tango-icon-theme-extras faience-icon-theme f26-backgrounds-extras-gnome
