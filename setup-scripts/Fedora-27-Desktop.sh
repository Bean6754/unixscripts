...
dnf install -y adwaita-cursor-theme adwaita-icon-theme arc-theme paper-icon-theme tango-icon-theme tango-icon-theme-extras faience-icon-theme oxygen-cursor-theme f26-backgrounds-extras-gnome
