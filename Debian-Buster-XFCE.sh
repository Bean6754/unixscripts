...
# High-level
apt install -y wireshark-gtk transmission transmission-cli gimp vlc libdvdnav4 libdvdread4 libdvdcss2 libbluray2 redshift redshift-gtk geany pidgin hv3 firefox-esr firefox-esr-l10n-en-gb
